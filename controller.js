...
app.controller('gameCtrl', ['$scope', '$log', 'ModalService', function($scope, $log, ModalService) {
    ...
    $scope.player3 = {'name': 'Player 3', 'score': 0, 'bet': 0};
    $scope.wrong1 = false;
    $scope.wrong2 = false;
    $scope.wrong3 = false;
	...
	$scope.round = {
					...
					'categories': {
								'Command Line': {
												'100':
													{'Is another name for Command Line': 'What is Shell, GUI, Terminal or Console?','url':'https://www.youtube.com/embed/C0DPdy98e4c'},
												'200':
...
app.controller('ModalController', function($scope, close) {
 ...
 $scope.close = function(result) {
    close(result, 600); // close, but give 500ms for bootstrap to animate
 };
